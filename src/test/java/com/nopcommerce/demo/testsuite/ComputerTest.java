...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductArrangeInAlphabeticalOrder() throws InterruptedException {
       ...
       // Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.id("products-orderby"),5);
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.xpath("//h2[@class='product-title']"),5);

        //2.4 Click on "Add To Cart"
        computerPage.addToCart();
        Thread.sleep(1000);
        //waitUntilVisibilityOfElementLocated(By.xpath("(//button[normalize-space()='Add to cart'])[1]"),5);
       ...
       // Thread.sleep(2000);
        waitUntilVisibilityOfElementLocated(By.id("product_attribute_4_9"),5);


        //2.11 Verify the price "$1,475.00"
        waitUntilVisibilityOfElementLocated(By.xpath("//span[@id='price-value-1']"), 5);
        Assert.assertEquals(computerPage.getPrice(), "$1,460.00", "Options not selected correctly");
       // Thread.sleep(1000);

        //2.12 Click on "ADD TO CARD" Button.
        computerPage.addToCart();
       // Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.id("price-value-1"),5);
       ...
       // Thread.sleep(2000);
        waitUntilVisibilityOfElementLocated(By.xpath("//input[@class='qty-input']"),5);
       ...
       // Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.id("termsofservice"),5);
        ...
        //Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.id("shippingoption_2"),5);
        ...
        //Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.xpath("//button[normalize-space()='Confirm']"),5);
