...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        //Thread.sleep(2000);
        waitUntilVisibilityOfElementLocated(By.xpath("//a[@title='List']"),5);
        ...
        //Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.xpath("(//input[@value])[2]"),5);
        ...
        billingPage.enterAddress("20, Watford road");
        billingPage.enterPostcode("Wd197sp");
        billingPage.enterPhoneNumber("7896556677");
        ...
        //Thread.sleep(1000);
        waitUntilVisibilityOfElementLocated(By.xpath("//select[@id='CreditCardType']"),5);
        ...
        billingPage.enterCardHolderName("Jess Wright");
        billingPage.enterCardNumber("5105105134562345");
        billingPage.selectExpiryMonth(1);
        billingPage.selectExpiryYear(2);
        billingPage.enterCVV("777");
