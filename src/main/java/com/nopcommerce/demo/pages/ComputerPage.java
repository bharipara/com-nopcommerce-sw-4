...
public class ComputerPage extends Utility {
    ...
    By addToCartButton=By.xpath("(//button[normalize-space()='Add to cart'])[1]");//By.xpath("//div[@class='item-grid']//div[1]//div[1]//div[2]//div[3]//div[2]//button[1]");
    ...
    public void selectProcessor(String value){
        selectByValueTextFromDropDown(processorLink,value);
    }
