...
public class BillingPage extends Utility {
    ...
    public void enterCity(String city){
        sentTextToElement(cityLink,city);
    }
    public void enterAddress(String address){
        sentTextToElement(addressLink,address);
    }
    public void enterPostcode(String postcode){
        sentTextToElement(postCodeLink,postcode);
    }
    public void enterPhoneNumber(String number){
        sentTextToElement(phoneNumberLink,number);
    }
    ...
    public void enterCardHolderName(String name){
        sentTextToElement(cardHolderNameLink,name);
    }
    public void enterCardNumber(String number){
        sentTextToElement(cardNumberLink,number);
    }
    ...
    public void enterCVV(String cvv){
        sentTextToElement(cardCVVLink,cvv);
    }
