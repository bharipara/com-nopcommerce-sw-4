...
public class ElectronicsPage extends Utility {
        ...
        By phoneLink = By.xpath("//h2/a[contains(text(),'Nokia Lumia 1020')]");//By.xpath("//h2[@class='product-title']//a[contains(text(),'Nokia Lumia 1020')]");
        ...
        public void changeQuantity(String quantity) {
            ...
            sentTextToElement(quantityLink, quantity);
        }
